...
export const Header = () => {
  ...
  return (
    ...
    <header className='lg:flex md:flex gap-5 h-auto lg:mb-8 grid mb-2'>
      ...
      <h1 className='font-bold text-white lg:text-md text-xs font-poppins lg:ml-auto md:ml-auto my-auto lg:px-3 px-5 py-1 rounded-full outline outline-3 text-center w-fit'>By Emma Huang: For Hack the North</h1>
      </header>
    </div>
    )
}
