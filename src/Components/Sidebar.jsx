  ...
  return (
    <div className='w-full h-fit grid gap-5' >
      ...
      <span className='flex gap-5'>
        <input autoComplete="off"  onChange={handleSearch} className='bg-black outline outline-4 outline-blue rounded-xl mt-1 px-3 py-1 lg:text-lg text-md text-white font-bold w-full' type="text" value={props.search} name="search" placeholder='Search events by name'/>
