...
export const EventDisplay = (props) => {
    ...
    const events = props.data?.map(
        (event, idx) =>
            <div key={idx}>
                <div className='grid gap-3 bg-grey rounded-xl p-8 drop-shadow-lg shadow-pureBlack'>
                ...
                <div className='grid grid-cols-2'>
                    ...
                    <div>
                        ...
                        <span className='flex gap-8 my-4 white'>
                    ...
                    <div className='flex gap-5'>
                        ...
                        }<a className='flex bg-gradient-to-r from-pink to-purple rounded-full py-2 px-5 text-center px-auto text-white text-xl w-fit font-extrabold shadow-md hover:shadow-pink shadow-purple transition-all duration-200' href={event.public_url ? event.public_url : event.private_url} target="_blank">More details <TbExternalLink  className='my-auto ml-2 text-2xl'/></a>
                ...
                {props.relatedEvents.id === event.id && 
                    <div className='my-3 flex gap-5'>
                        ...
                        <button onClick={clearRelated} className='ml-auto text-black font-bold my-auto bg-yellow rounded-full px-3 py-2 shadow-md shadow-black hover:shadow-yellow duration-200 transition'>Clear</button>
                    </div>
                }
            </div>
    )
