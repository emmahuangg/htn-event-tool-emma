      ...
      <div className='grid lg:grid-cols-2 bg-white rounded-xl  h-full w-full gap-4 mt-4 overflow-hidden'>
        ...
        <div className='lg:col-span-1 bg-white w-full'>
          ...
          <form autoComplete="off" onSubmit={handleLoginSubmit} className='lg:p-10 m-6 w-full'>
            ...
            <input className=' bg-white outline outline-2 outline-pink rounded-xl my-1 px-3 py-1 lg:text-lg text-black lg:w-80 w-60 text-sm' type="email" name="email" placeholder="hackTheNorthUser@gmail.com" value={formData.email} onChange={handleChange} />
            <p className='text-lg text-black font-bold my-1'>Password</p>
            <input className='bg-white outline outline-2 outline-pink rounded-xl my-1 px-3 py-1 lg:text-lg text-black lg:w-80 w-60 text-sm' type="password" name="password" placeholder="abcabcabc" value={formData.password} onChange={handleChange} />
